...
void TutCollisionDetection::Startup()
{
	...
	m_myJoint = new SpringJoint(m_mySphereA, m_mySphereB, 10, 0);
	...
	//m_physicsScene->AddAABB(m_myBoxA, glm::vec3(10, 0, 0), glm::vec3(-20, 0, 0), 1.0f, glm::vec3(1, 1, 1));
	//m_physicsScene->AddAABB(m_myBoxB, glm::vec3(-10, 0, 0), glm::vec3(20, 0, 0), 1.0f, glm::vec3(1, 1, 1));
